...
import { ChevronRight, Wrench, FuelIcon as Oil, Settings, Phone, Mail, Truck, Cog, Link2, TreePine, ShieldCheck, HelpCircle } from "lucide-react"
      ...
      <section className="relative w-full h-[90vh] min-h-[600px] flex items-center justify-center overflow-hidden bg-black">
        <div className="absolute inset-0 z-0">
          ...
          <Image
            ...
            alt="Shannon Hydraulics — hydraulic hose repair and hydraulic supplies in Limerick, Ireland"
            fill
        ...
        <div className="container relative z-10 px-4 mx-auto text-center">
          ...
          <p className="max-w-xl mx-auto mt-8 text-xl text-gray-300">
            Hydraulic hose repair, cylinder repairs, pumps, valves, motors &amp; supplies for industrial, agricultural and forestry clients across Ireland.
          </p>
          ...
          <div className="flex flex-col items-center md:flex-row md:items-start md:gap-16">
            <div className="w-full md:w-1/2 mb-12 md:mb-0">
              <div className="relative h-[500px] w-full rounded-xl overflow-hidden shadow-2xl">
                <Image
                  ...
                  alt="Shannon Hydraulics workshop in Crossagalla Industrial Estate, Limerick"
                  fill
            ...
            <div className="w-full md:w-1/2">
              ...
              <p className="text-gray-300 mb-6 text-lg">
                ...
                agricultural, and forestry clients throughout Ireland. Based in Limerick, we are your one-stop shop for everything hydraulic.
              </p>
              <p className="text-gray-300 mb-8 text-lg">
                We specialise in supplying and servicing a comprehensive range of hydraulic components and equipment.
                From hydraulic hose repair and manufacturing, cylinder and ram repairs, to the supply of hydraulic pumps,
                valves, motors, and power packs, we do it all. We also supply hydraulic oil (bring your own container for refills),
                grease and lubricants, hose fittings, seals, filters, quick-release couplings,
                copper brake pipes, heavy-duty chains, lifting gear, slings and shackles, log splitter cylinders,
                power washer lances and hoses, bucket teeth, and industrial paint. We carry spare parts for JCB, Hitachi,
                and CAT machinery.
              </p>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-8">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400">We supply premium-quality hydraulic products and components</p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  <div className="flex-shrink-0 w-12 h-12 rounded-lg bg-yellow-400 flex items-center justify-center text-black">
        ...
        <div className="container px-4 mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            <ServiceCard
              ...
              description="We manufacture and repair hydraulic hoses to the highest quality standards. Custom lengths and fittings available."
            />
            <ServiceCard
              icon={<Settings className="w-10 h-10" />}
              title="Hydraulic Cylinder & Ram Repair"
              description="Expert repair and supply of hydraulic cylinders and rams for industrial, agricultural, and forestry machinery."
            />

            <ServiceCard
              icon={<Oil className="w-10 h-10" />}
              title="Hydraulic Oil, Grease & Lubricants"
              description="Hydraulic oil refills (bring your own container), plus grease and lubricants. Forestry oil also available."
            />
            <ServiceCard
              icon={<Link2 className="w-10 h-10" />}
              title="Heavy-Duty Chains"
              description="Supply of premium heavy-duty chains with quality testing for industrial and agricultural use."
            />
            <ServiceCard
              icon={<Wrench className="w-10 h-10" />}
            ...
            <ServiceCard
              ...
              description="Supply of hydraulic cylinders specifically designed for log splitters."
            />
            <ServiceCard
              icon={<TreePine className="w-10 h-10" />}
              title="Forestry Oil & Hoses"
              description="Specialist forestry oil and hydraulic hoses suitable for forestry machinery and equipment."
            />
            <ServiceCard
              icon={<Wrench className="w-10 h-10" />}
              title="Copper Brake Pipes"
              description="Supply and assembly of copper brake pipes. Bring in your original and we will make a new one."
            />
            <ServiceCard
              icon={<ShieldCheck className="w-10 h-10" />}
              title="Lifting Gear, Slings & Shackles"
              description="Supply of lifting slings, shackles, and lifting gear for safe material handling."
            />
            <ServiceCard
              icon={<Settings className="w-10 h-10" />}
              title="JCB, Hitachi & CAT Spare Parts"
              description="Spare parts for JCB, Hitachi, and Caterpillar machinery. CAT hose repairs also available."
            />
            <ServiceCard
              icon={<ShieldCheck className="w-10 h-10" />}
              title="Seal Kits & Filters"
              description="Hydraulic seal kits, repair tools, oil filters, and filtration units to keep your systems clean and efficient."
            />
          ...
          <div className="bg-zinc-800/80 backdrop-blur-sm rounded-2xl p-12 max-w-4xl mx-auto">
            <div className="text-center">
              ...
              <p className="text-gray-300 mb-8 max-w-2xl mx-auto">
                Our team of specialists is ready to help with all your hydraulic needs from hose repairs and cylinder rebuilds to supplying pumps, valves, and motors.
              </p>
      ...
      <section className="py-24 bg-black" id="products">
        <div className="container px-4 mx-auto">
          <div className="text-center mb-16">
            ...
            <div className="w-20 h-1 bg-yellow-400 mx-auto mb-8"></div>
            <p className="mt-4 text-gray-300 max-w-2xl mx-auto text-lg">
              We stock a comprehensive range of high-quality hydraulic components, parts, and supplies to keep your systems
              running efficiently.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
            ...
            <ProductCard image="/images/cylinders.jpg" title="Hydraulic Cylinders & Rams" />
            ...
            <ProductCard image="/images/lance.png" title="Power Washer Lance & Hose" />
            <ProductCard image="/images/hydraulic_pump.jpg" title="Hydraulic Pumps" />
            <ProductCard image="/images/valve.jpg" title="Hydraulic Valves" />
            <ProductCard image="/images/motor.webp" title="Hydraulic Motors" />
            <ProductCard image="/images/powerpack.png" title="Hydraulic Power Packs" />
          ...
          <div className="mt-20">
            <div className="text-center mb-16">
              ...
              <p className="mt-4 text-gray-300 max-w-2xl mx-auto text-lg mb-10">
                Visit us at Unit 1, Crossagalla Industrial Estate, Limerick, V94 WP9F
              </p>
            </div>
            ...
            <div className="h-[500px] rounded-xl overflow-hidden shadow-2xl shadow-yellow-400/5">
              <iframe
                ...
                title="Shannon Hydraulics Location — Unit 1, Crossagalla Industrial Estate, Limerick"
              ></iframe>
            </div>
          </div>
        </div>
